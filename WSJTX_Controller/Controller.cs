...
private void replyDirCqCheckBox_CheckedChanged(object sender, EventArgs e)
        ...
        {
            ShowHelp($"Leave 'Start' time blank if you want to start transmit manually.");
        }
        ...
        {
            ShowHelp($"The Tx audio frequency is automatically set to an unused part of the audio spectrum.{Environment.NewLine}{Environment.NewLine}After a short period of no replies received to CQs sent, transmitting is temporarily suspended for one Tx cycle, the received audio is re-sampled, and the best Tx frequency is re-calculated.");
        }
