...
namespace WsjtxUdpLib.Messages.Out
{
    ...
    public class EnqueueDecodeMessage : DecodeMessage
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append($"{Col(IsNewCallOnBand, 5, Align.Left)} ");
            sb.Append($"{Col(IsNewCallAnyBand, 5, Align.Left)} ");
            sb.Append($"{Col(IsNewCountryOnBand, 5, Align.Left)} ");
            sb.Append($"{Col(IsNewCountry, 5, Align.Left)} ");
            sb.Append($"{Col(Priority, 1, Align.Left)} ");
            sb.Append($"{Col(Country, 17, Align.Left)} ");
        ...
        public static new WsjtxMessage Parse(byte[] message)
        {
            ...
            enqueueDecodeMessage.SequenceNumber = seqNum++;
