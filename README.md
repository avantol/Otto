...
<br><br>Click here > <b>https://github.com/avantol/Otto/blob/main/Otto.msi</b> (also above), then download <img src="https://github.com/avantol/WSJTX-Controller-v2/blob/main/dl.JPG"> and run to install: 
